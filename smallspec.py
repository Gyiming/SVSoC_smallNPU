...
def main():
    ...
    with open("soc_configure.cfg","r+") as cfgfile:
        ...
        latency_npu1 = int(config.get("info","latency_npu1"))
        latency_npu2 = int(config.get("info","latency_npu2"))
        energy_npu1 = int(config.get("info","energy_npu1"))
        energy_npu2 = int(config.get("info","energy_npu2"))
